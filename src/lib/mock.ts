...
// status: ALLOWED=승인(자동정산), EXPIRED/DENIED=미승인(매칭 보조 대상), null=계약행 없음
export const MOCK_USAGE: UsageRow[] = [
  { publisher: "NE능률", usedIsbn: "9791125337072", bookName: "Grammar Inside 그래머 인사이드 Level 1", userCount: 3, status: "ALLOWED", unitPrice: 15500 },
  { publisher: "NE능률", usedIsbn: "9791125347620", bookName: "리딩튜터 주니어 4 (개정판)", userCount: 2, status: "EXPIRED", unitPrice: null },
  { publisher: "NE능률", usedIsbn: "9791125342878", bookName: "1316 Reading Level 1", userCount: 1, status: "ALLOWED", unitPrice: 14000 },
  { publisher: "개념원리", usedIsbn: "9788961334839", bookName: "개념원리 고등 공통수학1(2025년 고1 적용)", userCount: 15, status: "ALLOWED", unitPrice: 19000 },
  { publisher: "개념원리", usedIsbn: "9788961335973", bookName: "개념원리 대수(2026)", userCount: 8, status: "ALLOWED", unitPrice: 19000 },
  { publisher: "쎄듀", usedIsbn: "9791125000001", bookName: "쎄듀 천일문 기본 (개정판)", userCount: 4, status: null, unitPrice: null },
  { publisher: "마더텅", usedIsbn: "9791175631205", bookName: "마더텅 수능기출문제집 확률과 통계(2026)", userCount: 2, status: "ALLOWED", unitPrice: 17900 },
  { publisher: "수경출판사", usedIsbn: "9791162409183", bookName: "Xistory 자이스토리 고3 수학 2 (2026년)", userCount: 3, status: "DENIED", unitPrice: null },
];
